...
<head>
  ...
  <style>
    :root {
      ...
      --color-fg: #0f0f0f;
      --color-fg-muted: rgba(15, 15, 15, 0.56);
      --color-accent: #0f0f0f;
      --color-grid-line: rgba(15, 15, 15, 0.045);
      --color-ring: rgba(15, 15, 15, 0.32);
      --color-ok: #0a7c45;
      --color-err: #b3261e;
      --shadow-card:
    ...
    @media (prefers-color-scheme: dark) {
      :root {
        ...
        --color-surface-soft: #2e2e35;
        --color-border: rgba(255, 255, 255, 0.12);
        --color-border-strong: rgba(255, 255, 255, 0.24);
        --color-fg: #f4f4f5;
        --color-fg-muted: rgba(244, 244, 245, 0.62);
        --color-accent: #f4f4f5;
        --color-grid-line: rgba(255, 255, 255, 0.05);
        --color-ring: rgba(255, 255, 255, 0.22);
        --shadow-card:
    ...
    * {
    ...
    body {
      ...
      padding: 32px 18px;
      background:
        linear-gradient(to right, var(--color-grid-line) 1px, transparent 1px) 0 0 / 24px 24px,
        linear-gradient(to bottom, var(--color-grid-line) 1px, transparent 1px) 0 0 / 24px 24px,
        var(--color-page);
      color: var(--color-fg);
    ...
    .pill {
      ...
      font-size: 12px;
      font-weight: 650;
      color: ${isSuccess ? "var(--color-ok)" : "var(--color-err)"};
