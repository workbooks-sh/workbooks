...
export type CellLanguage =
  ...
  | "wasm-fn"
  | "chat"
  // Routed via customCellRegistry (see agentElement.ts) — never reaches
  // the wasm dispatcher. Listed here so the parser + cell-bound HTML
  // authoring surface treat it as a first-class language.
  | "agent";
