...
- `packages/workbooks/packages/workbook-substrate/spikes/` — feasibility studies
- `packages/workbooks/packages/workbook-shell/README.md` — PWA shell hosting + install
